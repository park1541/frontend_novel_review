...
소설 리뷰를 작성하고 공유하는 풀스택 웹 서비스입니다.
Google / Naver / Kakao 소셜 로그인으로 바로 사용할 수 있습니다.
...
## 관리자 기능 데모 (ADMIN 계정 전용)

> 소셜 로그인 기반 서비스로 일반 계정으로는 관리자 페이지에 접근할 수 없습니다.

![관리자 기능 데모](docs/gifs/admin-demo.gif)
